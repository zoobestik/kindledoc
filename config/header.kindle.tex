...
% Reduce font size inside tables to avoid column overflow
\usepackage{etoolbox}
% Apply smaller font inside tabular/longtable and table floats
\AtBeginEnvironment{tabular}{\scriptsize}
\AtBeginEnvironment{longtable}{\scriptsize}
\AtBeginEnvironment{table}{\scriptsize}

% Поддержка кликабельных endnotes вместо обычных footnotes
\usepackage{enotez}
